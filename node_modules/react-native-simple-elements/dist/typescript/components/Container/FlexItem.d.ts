...
declare const FlexItem: {
    ({ left, right, content, title, description, onPress, style, focusedStyle, hoveredStyle, pressedStyle, rowStyle, contentStyle, titleStyle, titleNumberOfLines, descriptionNumberOfLines, titleEllipsizeMode, descriptionEllipsizeMode, descriptionStyle, ...rest }: Props): JSX.Element;
    displayName: string;
};
