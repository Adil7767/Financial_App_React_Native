...
const RadioButtonItem = ({
  ...
  return /*#__PURE__*/React.createElement(_RadioButtonGroup.RadioButtonContext.Consumer, null, context => {
    return /*#__PURE__*/React.createElement(_TouchableRipple.default, {
      ...
      pointerEvents: "none"
    }, !textAfterButton ? /*#__PURE__*/React.createElement(_Text.default, {
      style: [styles.label, {
        color: colors.text
      }, labelStyle]
    }, label) : null, radioButton, textAfterButton ? /*#__PURE__*/React.createElement(_Text.default, {
      style: [styles.label, {
        color: colors.text
      }, labelStyle]
    }, label) : null));
...
const RadioButtonItemWithTheme = RadioButtonItem; // @component-docs ignore-next-line
