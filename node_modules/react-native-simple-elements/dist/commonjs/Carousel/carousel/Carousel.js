...
const IS_IOS = _reactNative.Platform.OS === "ios"; // Native driver for scroll events
...
const AnimatedScrollView = _reactNative.Animated.createAnimatedComponent(_reactNative.ScrollView); // React Native automatically handles RTL layouts; unfortunately, it's buggy with horizontal ScrollView
...
class Carousel extends React.PureComponent {
  ...
  constructor(props) {
    super(props); // The following values are not stored in the state because 'setState()' is asynchronous
    ...
    _defineProperty(this, "_previousActiveItem", void 0);
    ...
    _defineProperty(this, "_currentContentOffset", void 0);

    _defineProperty(this, "_canFireBeforeCallback", void 0);

    _defineProperty(this, "_canFireCallback", void 0);

    _defineProperty(this, "_scrollOffsetRef", null);

    _defineProperty(this, "_onScrollTriggered", true);

    _defineProperty(this, "_lastScrollDate", void 0);

    _defineProperty(this, "_scrollEnabled", void 0);

    _defineProperty(this, "_ignoreNextMomentum", void 0);

    _defineProperty(this, "_carouselRef", void 0);
    ...
    _defineProperty(this, "_edgeItemTimeout", void 0);

    _defineProperty(this, "_lockScrollTimeout", void 0);

    _defineProperty(this, "_autoplayInterval", void 0);

    _defineProperty(this, "_itemToSnapTo", void 0);

    _defineProperty(this, "_autoplay", void 0);

    _defineProperty(this, "_autoplaying", void 0);

    _defineProperty(this, "_scrollStartOffset", void 0);

    _defineProperty(this, "_scrollStartActive", void 0);

    _defineProperty(this, "_scrollEndOffset", void 0);

    _defineProperty(this, "_scrollEndActive", void 0);

    _defineProperty(this, "_onLayoutInitDone", void 0);

    _defineProperty(this, "_getComponentOverridableProps", () => {
      const {
        enableMomentum,
        itemWidth,
        itemHeight,
    ...
    this._scrollEnabled = props.scrollEnabled !== false; // This bool aims at fixing an iOS bug due to scrollTo that triggers onMomentumScrollEnd.
    // onMomentumScrollEnd fires this._snapScroll, thus creating an infinite loop.
    ...
    this._setScrollHandler(props); // Warnings
  ...
  componentDidUpdate(prevProps) {
    ...
    const hasNewScrollEnabled = scrollEnabled !== prevProps.scrollEnabled; // Prevent issues with dynamically removed items
  ...
  _getSlideAnimation(index, toValue) {
    ...
    return _reactNative.Animated.parallel([_reactNative.Animated["timing"](animatedValue, { ...animationCommonOptions,
      easing: _reactNative.Easing.linear
    }), _reactNative.Animated[activeAnimationType](animatedValue, { ...animationCommonOptions
    })]);
  }
  ...
  _playCustomSlideAnimation(current, next) {
    ...
    const animations = []; // Keep animations in sync when looping
  ...
  _snapScroll(delta) {
    const {
      swipeThreshold
    } = this.props; // When using momentum and releasing the touch with
  ...
  _renderItem({
    ...
    const specificProps = this._needsScrollView() ? {
      key: keyExtractor // @ts-ignore
      ? keyExtractor(item, index) : this._getKeyExtractor(item, index)
    } : {};
  ...
  render() {
    ...
    /*#__PURE__*/
    // @ts-ignore
    React.createElement(ScrollViewComponent, props, this._getCustomData().map((item, index) => {
    ...
    /*#__PURE__*/
    // @ts-ignore
    React.createElement(AnimatedFlatList, props);
  }
