...
class ReactNativeModal extends React.Component {
  ...
  constructor(props) {
    ...
    _defineProperty(this, "state", {
      showContent: true,
      isVisible: false,
      deviceWidth: _reactNative.Dimensions.get("screen").width,
      deviceHeight: _reactNative.Dimensions.get("screen").height,
    ...
    _defineProperty(this, "open", () => {
      ...
      if (this.contentRef) {
        ...
        const interactionHandle = _reactNative.InteractionManager.createInteractionHandle();

        this.contentRef.animate(this.animationIn, this.props.animationInTiming).then(() => {
          this.isTransitioning = false;

          _reactNative.InteractionManager.clearInteractionHandle(interactionHandle);
  ...
  render() {
    ...
    }, otherProps), this.makeBackdrop(), avoidKeyboard ? /*#__PURE__*/React.createElement(_reactNative.KeyboardAvoidingView, {
