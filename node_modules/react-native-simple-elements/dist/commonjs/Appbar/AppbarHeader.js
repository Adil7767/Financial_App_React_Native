...
var _overlay = _interopRequireDefault(require("../theme/overlay"));

var _Appbar = require("./Appbar");

var _shadow = _interopRequireDefault(require("../theme/shadow"));
...
const AppbarHeader = props => {
  ...
  const backgroundColor = customBackground ? customBackground : isDarkTheme && mode === "adaptive" ? (0, _overlay.default)(elevation, colors.surface) : colors.white; // Let the user override the behaviour
...
const AppbarHeaderWithTheme = AppbarHeader; // @component-docs ignore-next-line
