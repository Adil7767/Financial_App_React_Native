...
var _closeCircle = _interopRequireDefault(require("@mdi/svg/svg/close-circle.svg"));
...
const Chip = ({
  ...
  return /*#__PURE__*/React.createElement(_Surface.default, _extends({
    ...
    disabled: disabled,
    accessibilityLabel: accessibilityLabel // accessibilityTraits={accessibilityTraits}
  ...
  }, icon ? /*#__PURE__*/React.createElement(_Icon.SvgIcon, {
    icon: icon,
    ...
    onPress: onClose // accessibilityTraits="button"
    // accessibilityComponentType="button"
    ,
    accessibilityRole: "button",
