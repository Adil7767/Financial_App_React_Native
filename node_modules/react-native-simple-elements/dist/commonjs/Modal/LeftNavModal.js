...
const LeftNavModal = props => {
  ...
  const animatedWidth = React.useRef(new _reactNative.Animated.Value(0));
  ...
  const setModalVisible = (visible, props) => {
    ...
    if (visible) {
      ...
      _reactNative.Animated.timing(animatedWidth.current, {
      ...
      _reactNative.Animated.timing(animatedWidth.current, {
        ...
        animatedWidth.current = new _reactNative.Animated.Value(0), setVisible(visible); // this.setState({
  ...
  }, children)), showMask ? /*#__PURE__*/React.createElement(_reactNative.TouchableOpacity, {
    style: {
      flex: 1,
      // backgroundColor: "transparent",
...
var _default = LeftNavModal;
exports.default = _default;
//# sourceMappingURL=LeftNavModal.js.map