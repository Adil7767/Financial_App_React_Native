...
const AlertModal = props => {
  ...
  const opacityValue = React.useRef(new _reactNative.Animated.Value(0)).current;
  const transformValue = React.useRef(new _reactNative.Animated.Value(0.9)).current;
  ...
  const setModalVisible = (visible, props) => {
    ...
    if (visible) {
      ...
      _reactNative.Animated.parallel([_reactNative.Animated.timing(opacityValue, {
        toValue: 1,
        duration: openDuration || 300,
        useNativeDriver: true
      }), _reactNative.Animated.timing(transformValue, {
        toValue: 1,
        duration: openDuration || 300,
        useNativeDriver: true
      })]).start();
