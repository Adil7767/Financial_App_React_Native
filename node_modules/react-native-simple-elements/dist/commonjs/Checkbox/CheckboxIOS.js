...
var _minus = _interopRequireDefault(require("@mdi/svg/svg/minus.svg"));

var _check = _interopRequireDefault(require("@mdi/svg/svg/check.svg"));
...
const CheckboxIOS = ({
  ...
  const icon = indeterminate ? _minus.default : _check.default;
...
const CheckboxIOSWithTheme = CheckboxIOS; // @component-docs ignore-next-line
