...
var _minusBox = _interopRequireDefault(require("@mdi/svg/svg/minus-box.svg"));

var _checkboxMarked = _interopRequireDefault(require("@mdi/svg/svg/checkbox-marked.svg"));

var _checkboxBlankOutline = _interopRequireDefault(require("@mdi/svg/svg/checkbox-blank-outline.svg"));
...
const CheckboxAndroid = ({
  ...
  const icon = indeterminate ? _minusBox.default : checked ? _checkboxMarked.default : _checkboxBlankOutline.default;
  return /*#__PURE__*/React.createElement(_TouchableRipple.default, _extends({}, rest, {
    borderless: true,
    rippleColor: rippleColor,
    onPress: onPress,
    disabled: disabled // accessibilityTraits={disabled ? ['button', 'disabled'] : 'button'}
    ...
    icon: icon,
    size: 24,
    color: checkboxColor // direction="ltr"
...
const CheckboxAndroidWithTheme = CheckboxAndroid; // @component-docs ignore-next-line
