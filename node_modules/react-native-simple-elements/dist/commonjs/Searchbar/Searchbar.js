...
var _magnify = _interopRequireDefault(require("@mdi/svg/svg/magnify.svg"));

var _close = _interopRequireDefault(require("@mdi/svg/svg/close.svg"));
...
const Searchbar = /*#__PURE__*/React.forwardRef(({
  ...
  }, /*#__PURE__*/React.createElement(_IconButton.default // accessibilityTraits="button"
  ...
  , {
    ...
    onPress: onIconPress,
    color: iconColor,
    size: 24 // direction={I18nManager.isRTL ? 'rtl' : 'ltr'}
    ,
    icon: icon || _magnify.default,
    ...
    keyboardAppearance: dark ? "dark" : "light" // accessibilityTraits="search"
    ,
    ...
    icon: clearIcon || _close.default // accessibilityTraits="button"
    // accessibilityComponentType="button"
    ,
    accessibilityRole: "button"
  }));
