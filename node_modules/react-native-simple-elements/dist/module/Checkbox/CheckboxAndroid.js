...
const CheckboxAndroid = ({
  ...
  const icon = indeterminate ? MinusBoxIcon : checked ? CheckboxMarkedIcon : CheckboxBlankOutlineIcon;
...
export default CheckboxAndroid; // @component-docs ignore-next-line
