...
const IS_IOS = Platform.OS === "ios"; // Native driver for scroll events
// See: https://facebook.github.io/react-native/blog/2017/02/14/using-native-driver-for-animated.html

const AnimatedFlatList = FlatList ? Animated.createAnimatedComponent(FlatList) : null;
const AnimatedScrollView = Animated.createAnimatedComponent(ScrollView); // React Native automatically handles RTL layouts; unfortunately, it's buggy with horizontal ScrollView
...
export default class Carousel extends React.PureComponent {
  ...
  _getSlideAnimation(index, toValue) {
    ...
    return Animated.parallel([Animated["timing"](animatedValue, { ...animationCommonOptions,
