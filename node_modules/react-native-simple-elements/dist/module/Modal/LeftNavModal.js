...
import { View, KeyboardAvoidingView, Modal as RNModal, TouchableOpacity, Animated, PanResponder, Platform, Dimensions } from "react-native";
...
const LeftNavModal = props => {
  ...
  const setModalVisible = (visible, props) => {
    ...
    if (visible) {
      ...
      Animated.timing(animatedWidth.current, {
        ...
        animatedWidth.current = new Animated.Value(0), setVisible(visible); // this.setState({
  ...
  }, children)), showMask ? /*#__PURE__*/React.createElement(TouchableOpacity, {
    style: {
      flex: 1,
      // backgroundColor: "transparent",
