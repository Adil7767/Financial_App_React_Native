...
import { View, KeyboardAvoidingView, Modal as RNModal, TouchableOpacity, Animated, PanResponder, Platform } from "react-native";
  ...
  const setModalVisible = (visible, props) => {
    ...
    if (visible) {
      ...
      Animated.timing(animatedHeight.current, {
        ...
        animatedHeight.current = new Animated.Value(0), setVisible(visible); // this.setState({
