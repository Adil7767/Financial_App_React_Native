...
import { View, KeyboardAvoidingView, Modal as RNModal, Animated, PanResponder, Platform, StyleSheet } from "react-native";
...
const BottomSheet = ({
  ...
  const setModalVisible = visible => {
    if (visible) {
      ...
      Animated.timing(scaleYValue.current, {
        ...
        setIsVisible(visible);
        scaleYValue.current = new Animated.Value(0); // this.setState({
  ...
  , {
    ...
    style: [styles.backdrop, {
      ...
      opacity: scaleYValue.current.interpolate({
