...
const {
  width: WIDTH,
  height: HEIGHT
} = Dimensions.get("window"); // const SwiperFlatList = React.forwardRef<RefProps, SwiperFlatListProps<SwiperType>>(

export const SwiperFlatList = /*#__PURE__*/React.forwardRef( // <T1 extends any>(
({
  vertical = false,
  children,
  data = [],
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(FlatList, flatListProps), showPagination && /*#__PURE__*/React.createElement(PaginationComponent, paginationProps));
