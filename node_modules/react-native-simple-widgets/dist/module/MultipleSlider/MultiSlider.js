...
import { StyleSheet, PanResponder, View, Platform // Dimensions,
, I18nManager, ImageBackground } from "react-native";
...
export default class MultiSlider extends React.Component {
  constructor(props) {
    ...
    _defineProperty(this, "moveOne", gestureState => {
      ...
      if (Math.abs(accumDistanceDisplacement) < slipDisplacement || !slipDisplacement) {
        const value = positionToValue(confined, this.optionsArray, this.props.sliderLength, this.props.markerSize);
        const snapped = valueToPosition(value, this.optionsArray, this.props.sliderLength, this.props.markerSize);
        this.setState({
    ...
    _defineProperty(this, "endOne", gestureState => {
      ...
      const snapped = valueToPosition(this.state.valueOne, this.optionsArray, this.props.sliderLength);
      this.setState({
    ...
    _defineProperty(this, "endTwo", gestureState => {
      ...
      const snapped = valueToPosition(this.state.valueTwo, this.optionsArray, this.props.sliderLength);
      this.setState({
        twoPressed: !this.state.twoPressed,
    ...
    const initialValues = this.props.values.map(value => valueToPosition(value, this.optionsArray, this.props.sliderLength, this.props.markerSize));
    const tempStepsAs = {};
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (prevProps.min !== this.props.min || prevProps.max !== this.props.max || prevProps.step !== this.props.step || prevProps.values[0] !== this.props.values[0] || prevProps.sliderLength !== this.props.sliderLength || prevProps.values[1] !== this.props.values[1] || prevProps.sliderLength !== this.props.sliderLength && prevProps.values[1]) {
      ...
      const positionOne = valueToPosition(this.props.values[0], this.optionsArray, this.props.sliderLength, this.props.markerSize);
      nextState.valueOne = this.props.values[0];
      nextState.pastOne = positionOne;
      nextState.positionOne = positionOne;
      const positionTwo = valueToPosition(this.props.values[1], this.optionsArray, this.props.sliderLength, this.props.markerSize);
  ...
  getSteps() {
    ...
    return this.optionsArray.map((number, index) => {
      ...
      }, this.props.showStepMarkers && index !== 0 && index !== this.optionsArray.length - 1 && /*#__PURE__*/React.createElement(View, {
        style: markerStyles
      }), this.props.showStepLabels && /*#__PURE__*/React.createElement(Text, {
        style: textStyles
  ...
  render() {
    ...
    const body = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(View, {
    ...
    }, twoMarkers ? this._panResponderBetween.panHandlers : {})), twoMarkers && /*#__PURE__*/React.createElement(View, {
      style: [styles.track, this.props.trackStyle, trackThreeStyle, {
        width: trackThreeLength
      }]
    }), this.props.showSteps && this.getSteps(), /*#__PURE__*/React.createElement(View, {
    ...
    React.createElement(MarkerLeft, {
      ...
      valuePrefix: this.props.valuePrefix,
      valueSuffix: this.props.valueSuffix
    }))), twoMarkers && positionOne !== this.props.sliderLength && /*#__PURE__*/React.createElement(View, {
    ...
    }), this.props.imageBackgroundSource && /*#__PURE__*/React.createElement(ImageBackground, {
      source: this.props.imageBackgroundSource,
      style: [{
        width: "100%",
        height: "100%"
      }, containerStyle]
    }, body), !this.props.imageBackgroundSource && /*#__PURE__*/React.createElement(View, {
