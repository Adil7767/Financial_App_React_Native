...
export default class ViewTransformer extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(View, _extends({}, this.props, gestureResponder, {
      //   ref={'innerViewRef'}
      ref: el => {
  ...
  onResponderMove(evt, gestureState) {
    ...
    if (gestureState.previousPinch && gestureState.pinch && this.props.enableScale) {
      ...
      const rect = transformedRect(transformedRect(this.contentRect(), this.currentTransform()), new Transform(scaleBy, dx, dy, {
        x: pivotX,
        y: pivotY
      }));
  ...
  performDoubleTapUp(pivotX, pivotY) {
    ...
    let rect = transformedRect(this.transformedContentRect(), new Transform(scaleBy, 0, 0, {
      x: pivotX,
      y: pivotY
    }));
...
_defineProperty(ViewTransformer, "Rect", Rect);

_defineProperty(ViewTransformer, "getTransform", getTransform);
