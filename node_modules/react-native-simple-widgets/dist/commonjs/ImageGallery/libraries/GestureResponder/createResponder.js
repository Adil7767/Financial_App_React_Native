 ...
 */
// copied from react/lib/TouchHistoryMath.js
...
const MOVE_THRESHOLD = 2; // let DEV = false;
...
function updateGestureStateOnMove(gestureState, touchHistory, e) {
  ...
  gestureState.moveY = y; // TODO: This must be filtered intelligently.
...
function create(config) {
  ...
  const handlers = {
    ...
    onStartShouldSetResponderCapture: function (e) {
      ...
      cancelSingleTapConfirm(gestureState); // TODO: Actually, we should reinitialize the state any time
    ...
    onMoveShouldSetResponderCapture: function (e) {
      ...
      const touchHistory = e.touchHistory; // Responder system incorrectly dispatches should* to current responder
    ...
    onResponderRelease: function (e) {
      if (gestureState.singleTapUp) {
        ...
        gestureState._lastSingleTapUp = true; // schedule to confirm single tap

        if (!gestureState.doubleTapUp) {
          const snapshot = Object.assign({}, gestureState);

          const timeoutId = _reactTimerMixin.default.setTimeout(() => {
      ...
      gestureState._lastReleaseTimestamp = e.touchHistory.mostRecentTimeStamp; // DEV && console.log("onResponderRelease..." + JSON.stringify(gestureState));
    ...
    onResponderMove: function (e) {
      const touchHistory = e.touchHistory; // Guard against the dispatch of two touch moves when there are two
...
//# sourceMappingURL=createResponder.js.map