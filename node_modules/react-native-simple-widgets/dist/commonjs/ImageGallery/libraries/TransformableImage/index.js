...
var _ViewTransformer = _interopRequireDefault(require("../ViewTransformer"));
...
class TransformableImage extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  getImageSize(image) {
    ...
    if (source && source.uri) {
      _reactNative.Image.getSize(source.uri, (width, height) => {
        if (width && height) {
  ...
  renderError() {
    return this.props.errorComponent && this.props.errorComponent() || /*#__PURE__*/React.createElement(_reactNative.View, {
      style: {
        flex: 1,
  ...
  render() {
    ...
    const content = imageComponent ? imageComponent(imageProps, imageDimensions) : /*#__PURE__*/React.createElement(_reactNative.Image, imageProps);
    return /*#__PURE__*/React.createElement(_ViewTransformer.default // ref={"viewTransformer"}
    , {
      ref: el => {
...
exports.default = TransformableImage;
