...
const MIN_FLING_VELOCITY = 0.5; // Dimensions are only used initially.
...
class ViewPager extends React.PureComponent {
  ...
  constructor(props) {
    ...
    _defineProperty(this, "layoutChanged", false);

    _defineProperty(this, "activeGesture", false);
    ...
    _defineProperty(this, "flatlistRef", void 0);
  ...
  createScroller() {
    return new _Scroller.default(true, (dx, dy, scroller) => {
      if (dx === 0 && dy === 0 && scroller.isFinished()) {
        if (!this.activeGesture) {
          this.onPageScrollStateChanged("idle");
        }
      } else {
        const curX = this.scroller.getCurrX(); // this.refs['innerFlatList'] && this.refs['innerFlatList'].scrollToOffset({ offset: curX, animated: false });
  ...
  scrollToPage(page, immediate) {
    ...
    if (immediate) {
      _reactNative.InteractionManager.runAfterInteractions(() => {
        this.scroller.startScroll(this.scroller.getCurrX(), 0, finalX - this.scroller.getCurrX(), 0, 0); // this.refs['innerFlatList'] && this.refs['innerFlatList'].scrollToOffset({ offset: finalX, animated: false });
  ...
  renderRow({
    ...
    const element = /*#__PURE__*/React.createElement(page.type, newProps);
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(_reactNative.View, _extends({}, this.props, {
      style: [style, {
        flex: 1
      }]
    }, gestureResponder), /*#__PURE__*/React.createElement(_reactNative.FlatList, _extends({}, this.props.flatListProps, {
      style: [{
        flex: 1
      }, scrollViewStyle],
      ref: el => {
      ...
      onLayout: this.onLayout // use contentOffset instead of initialScrollIndex so that we don't have
      ...
      ,
      contentOffset: {
        x: this.getScrollOffsetOfPage(parseInt("".concat(this.props.initialPage))),
        y: 0
      }
    })));
  }
...
_defineProperty(ViewPager, "defaultProps", {
  initialPage: 0,
  pageMargin: 0,
  scrollEnabled: true,
  pageDataArray: [],
