...
var _mweb = _interopRequireDefault(require("./mweb"));
...
class SelectPicker extends React.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "handleScrollChange", (date, arg2) => {
      if (this.props.onValueChange) {
        this.props.onValueChange(date);
      }
  ...
  static getDerivedStateFromProps(props, state) {
    if (props.isVisible && !state.isPickerVisible) {
      return {
        currentDate: props.selectedValue,
  ...
  render() {
    ...
    const PickerComponent = _mweb.default;
    ...
    , _extends({}, otherProps, {
      selectedValue: this.state.currentDate // onChange={this.handleChange}
      ,
      onValueChange: this.handleChange,
      onScrollChange: this.handleScrollChange
    }), options.map(item => /*#__PURE__*/React.createElement(PickerComponent.Item, {
      key: item.value,
      value: item.value
    }, item.label)))), /*#__PURE__*/React.createElement(ConfirmButtonComponent, {
...
//# sourceMappingURL=SelectPicker.mweb.js.map