...
var _MultiPicker = _interopRequireDefault(require("../../SelectPicker/mweb/MultiPicker"));

var _Picker = _interopRequireDefault(require("../../SelectPicker/mweb/Picker"));
...
class DatePicker extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "defaultMinDate", void 0);

    _defineProperty(this, "defaultMaxDate", void 0);

    _defineProperty(this, "getNewDate", (values, index) => {
    ...
    _defineProperty(this, "onValueChange", (values, index) => {
      const props = this.props;
    ...
    _defineProperty(this, "onScrollChange", (values, index) => {
      const props = this.props;
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement(_MultiPicker.default, {
      style: multiStyle,
    ...
    }, cols.map(p => /*#__PURE__*/React.createElement(_Picker.default, {
      style: {
        flex: 1
      },
      key: p.key,
      ...
      itemStyle: itemStyle
    }, p.props.children.map(item => /*#__PURE__*/React.createElement(_Picker.default.Item, {
      key: item.value,
      value: item.value
    }, item.label)))));
  }
