...
var _DateTimePicker = _interopRequireDefault(require("./mweb/DateTimePicker"));
...
const convertValuesToDate = (cur, values, index, use12Hours) => {
  ...
  switch (index) {
    case 0:
      newDate = (0, _set.default)(newDate, {
        year: values[index]
      });
      break;
    ...
    case 3:
      newDate = (0, _set.default)(newDate, {
        hours: use12Hours && newDate.getHours() >= 12 ? parseInt(values[index], 10) + 12 : values[index]
      });
      break;
    ...
    case 5:
      if (parseInt(values[index], 10) === 0) {
        newDate = (0, _set.default)(newDate, {
          hours: newDate.getHours() >= 12 ? newDate.getHours() - 12 : newDate.getHours()
        });
      } else {
        newDate = (0, _set.default)(newDate, {
...
class DateTimePickerWeb extends React.PureComponent {
  constructor(...args) {
    super(...args);
    ...
    _defineProperty(this, "handleChange", (date, index) => {
      if (this.props.onChange) {
        this.props.onChange(date);
      }

      this.setState({
        currentDate: convertValuesToDate(this.state.currentDate, date, index, this.props.use12Hours)
      });
    });
  }
  ...
  render() {
    ...
    const PickerComponent = _DateTimePicker.default;
    const themedContainerStyle = _isDarkModeEnabled ? pickerStyles.containerDark : pickerStyles.containerLight;
    const headerText = headerTextIOS || (this.props.mode === "time" ? "Pick a time" : "Pick a date");
    ...
    , _extends({}, otherProps, {
      date: this.state.currentDate // onChange={this.handleChange}
      ,
...
_defineProperty(DateTimePickerWeb, "defaultProps", {
...
var _default = DateTimePickerWeb;
exports.default = _default;
//# sourceMappingURL=DateTimePicker.mweb.js.map